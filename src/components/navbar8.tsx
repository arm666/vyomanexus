                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Welcome to our multidisciplinary engineering
                                  company
                                </span>
                              </Fragment>
                            )}
...
Navbar8.defaultProps = {
  ...
  page2: undefined,
  link4: undefined,
  page4ImageAlt: "Contact icon for communication",
  page1Description: undefined,
  page2ImageSrc:
    "https://images.unsplash.com/photo-1629709304968-627a15a1936c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjA3MTM2N3w&ixlib=rb-4.1.0&q=80&w=1080",
  page3ImageSrc:
    "https://images.unsplash.com/photo-1650192878511-85d423f4d97e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjA3MTM2OHw&ixlib=rb-4.1.0&q=80&w=1080",
...
interface Props {
  linkUrlPage4: string;
  link2Url: string;
  page4Description: React.ReactNode;
  ...
  page1Description: React.ReactNode;
  page2ImageSrc: string;
  page3ImageSrc: string;
  page2Description: React.ReactNode;
  link3: React.ReactNode;
  page3: React.ReactNode;
  link1Url: string;
  page3Description: React.ReactNode;
